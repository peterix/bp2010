...
\projectinfo{
  ...
  %Ustav
  department=DCGM, % doplnte prislusnou zkratku: UPSY/UIFS/UITS/UPGM
  %Skolitel
  ...
  %===========================================================================
  %Klicova slova
  keywords.cs={KDE Kiosk KAuth KAuthorized KioskTool}, %klicova slova v ceskem jazyce
  keywords.en={KDE Kiosk KAuth KAuthorized KioskTool}, %klicova slova v anglickem jazyce
  %Abstract
